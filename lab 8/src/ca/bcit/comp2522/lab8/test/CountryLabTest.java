package ca.bcit.comp2522.lab8.test;

import static org.junit.jupiter.api.Assertions.*;

import ca.bcit.comp2522.lab8.code.CountryLab;
...
public class CountryLabTest {
    ...
    final Path matchesDir = Paths.get("ca","bcit","comp2522","lab8","matches");
    ...
    public void testDirectoryCreation() {
        assertTrue(Files.exists(matchesDir),
                "matches directory should be created");
    }

    @Test
    public void testDataFileCreation() {
        assertTrue(Files.exists(dataFile),
                "data.txt file should be created");
    }
    ...
    public void testCountryNamesLongerThan10Characters() throws IOException {
        ...
        assertTrue(lines.contains("Afghanistan"),
                "Afghanistan should be listed as a country longer than 10 characters");
    }
